...
export async function updateUserRole(userId: string, newRole: 'admin' | 'usuario') {
...
export async function deleteUser(userId: string) {
  ...
  if (error) {
    ...
    return { success: false, message: `No se pudo eliminar el usuario. Error: ${error.message}` }
  }
