    ...
    <div className="container mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <div className="bg-white p-8 sm:p-10 rounded-xl shadow-xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 id="quien" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
          ...
          <h2 id="alcance" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
          ...
          <h2 id="datos" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
          ...
          <h2 id="finalidades" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
          ...
          <h2 id="plazos" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
          ...
          <h2 id="destinatarios" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
          ...
          <h2 id="derechos" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
            8. Sus derechos
          </h2>
          <p>
          ...
          <h2 id="menores" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
            10. Menores
          </h2>
          <p>
          ...
          <h2 id="cookies" className="text-2xl font-bold text-gray-900 mt-12 mb-4 pb-2 border-b border-primary-200">
            11. Cookies
          </h2>
          <p>
