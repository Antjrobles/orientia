...
export const metadata: Metadata = {
  ...
  description:
    "Gestiona tus preferencias de cookies por categorías en Orientia.",
  robots: {
    index: false,
    follow: true,
  },
    ...
    <div className="container mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <div className="bg-white p-8 sm:p-10 rounded-xl shadow-xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mb-6">
              Revisa la información y, próximamente, gestiona tus preferencias
              por categorías.
            </p>
          </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-3 pb-2 border-b border-primary-200">
            Categorías
          </h2>
          <AjustesCookiesPanel />
          ...
          <div className="mt-8 p-4 bg-gray-50 border border-gray-200 rounded-lg not-prose">
            <p className="text-sm text-gray-700">
              Nota: Este panel controla tus preferencias y las sincroniza con el
              banner. Algunas integraciones pueden requerir recargar la página
