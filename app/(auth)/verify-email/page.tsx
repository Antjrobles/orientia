...
export default function VerifyEmailPage() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setResendNotice(
          "Hemos enviado un nuevo enlace de verificación. Revisa tu bandeja.",
        );
    ...
    <div>
      <AuthCard>
        <AuthHeader
          ...
          subtitle="Procesando tu solicitud de verificación"
        />
        {status === "loading" && (
        ...
        {status === "success" && (
          <div className="space-y-3 sm:space-y-4 text-center">
            ...
            <p className="text-sm text-gray-600">
              Tu cuenta ha sido verificada. Te redirigimos al acceso.
            </p>
            ...
            {autoRedirectEnabled && typeof redirectSeconds === "number" && (
              <p className="mt-1 flex items-center justify-center gap-2 text-xs text-gray-500">
                <Timer className="h-3.5 w-3.5" /> Redirigiendo en{" "}
                {redirectSeconds}s
              </p>
            )}
          </div>
        ...
        {status === "expired" && (
          <div className="space-y-3 sm:space-y-4 text-center">
            ...
            <div className="space-y-2 text-left">
              ...
              >
                Introduce tu correo para reenviar{" "}
