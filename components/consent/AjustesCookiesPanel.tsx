...
export default function AjustesCookiesPanel() {
  ...
  const update = (k: keyof typeof local, v: boolean) =>
    setLocal({ ...local, [k]: k === "necessary" ? true : v });
          ...
          [
            {
              key: "necessary",
              label: "Necesarias",
              desc: "Esenciales para el funcionamiento del sitio (no configurables).",
              disabled: true,
            },
            {
              key: "preferences",
              label: "Preferencias",
              desc: "Recuerdan idioma u otras opciones de interfaz.",
            },
            {
              key: "analytics",
              label: "Analítica",
              desc: "Ayudan a entender el uso de la plataforma de forma agregada.",
            },
            {
              key: "performance",
              label: "Rendimiento",
              desc: "Mejoran velocidad y experiencia.",
            },
            {
              key: "ads",
              label: "Publicidad (si aplica)",
              desc: "Muestran contenido más relevante.",
            },
          ] as const
        ).map((cat) => (
          <label
