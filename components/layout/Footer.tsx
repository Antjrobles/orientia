              ...
              <nav aria-label="Recursos">
                <ul className="space-y-2">
                  {[
                    ...
                    {
                      href: "https://www.juntadeandalucia.es/educacion",
                      label: "Consejería Educación",
                      external: true,
                    },
                    {
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    { href: "/rgpd", label: "RGPD" },
                    {
                      ...
                      label: "Eliminación de datos de usuario",
                    },
                  ].map((link) => (
                    <li key={link.href}>
                      <Link
            ...
            <div>
              ...
              <address className="not-italic space-y-2">
                <a
                  ...
                  className="flex items-center space-x-2 text-gray-300 text-sm hover:text-green-500 transition-colors"
                >
                ...
                <p className="flex items-start space-x-2 text-gray-300 text-sm pt-2">
