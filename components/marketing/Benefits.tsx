      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 mb-8 mx-auto max-w-2xl">
            Diseñado por y para profesionales de la orientación educativa,
            nuestro sistema comprende las necesidades específicas de tu trabajo
            diario.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Automatiza la redacción manteniendo tu criterio profesional
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Garantiza coherencia en la terminología y estructura de
                    todos tus informes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Soporte especializado y actualizaciones continuas basadas en
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Compatible con los sistemas existentes de la Junta de
                    Andalucía.
                  </p>
                </div>
              </div>
